...
<head>
    ...
    <style>
        ...
        .wrapper .sidebar ul li {
            padding: 15px;
            border-bottom: 1px solid #1d20e4;
...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top" style="padding:8px;border:none;background-color:#1d20e4;border-bottom:1px solid black;box-shadow: 3px 3px 5px black;">
